...
| 2026-09-07 | R7 audit hardening | Complete | Added recoverable malformed-H4 handling, configurable H4/L2CAP memory bounds, per-fragment Number Of Completed Packets tests, ATT notification/indication telemetry helpers, Classic L2CAP dynamic channel signaling, configurable SDP responses, and RFCOMM PSM establishment/configuration/disconnection coverage. |
